...
import MarcasCarrousel from '@/components/MarcasCarrousel'
...
const perks = [
  {
    ...
    Icon: Box,
    description: "Hacemos envios a Santiago todos los meses, retira en Sucursal" 
  },
  {
    ...
    <Inicio/>
      ...
      <section className="border-t border-gray-200 bg-gray-50">
        <MaxWidthWrapper className="py-2">
          <div className="grid grid-col-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-8 mt-10">
            {perks.map((perk) => (
              <div
                key={perk.name}
